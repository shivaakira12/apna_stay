package com.apnastay.controller;

import com.apnastay.dto.Response;
import com.apnastay.service.Interc.IBookingService;
...
public class RoomController {
    ...
    public ResponseEntity<Response> getAvailableRoomsByDateAndType(
        ...
        Response response = roomService.getAvailableRoomsByTypeAndDate(checkInDate, checkOutDate, roomType);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
