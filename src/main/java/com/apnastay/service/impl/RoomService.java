...
import com.apnastay.dto.RoomDTO;
import com.apnastay.entity.Room;
import com.apnastay.exception.OurException;
import com.apnastay.repo.BookingRepository;
import com.apnastay.repo.RoomRepository;
import com.apnastay.service.AwsS3Service;
import com.apnastay.service.Interc.IRoomService;
...
public class RoomService implements IRoomService {
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            ...
            RoomDTO roomDTO = Utils.mapRoomEntityToRoomDTO(savedRooms);
    ...
    public Response getAllRooms() {
        ...
        try {
            ...
            response.setStatusCode(200);
            response.setMessage("Fetched All Rooms Successfully");
    ...
    @Override
    public Response getAvailableRoomsByTypeAndDate(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        Response response = new Response();
